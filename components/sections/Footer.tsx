  ...
  return (
    <footer className="border-t border-[#E6DED2] bg-[#F7F5F2]">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-12 md:flex-row md:items-center md:justify-between">
        <div><Logo className="h-20 w-auto" priority={false} /><p className="mt-4 max-w-xl text-sm leading-6 text-[#666666]">Ukážkový webový koncept vytvorený Samuelom Zelískom. Nejde o skutočné barber štúdio ani ponuku služieb.</p></div>
